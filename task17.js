...
// products qiymeti user terefinden daxil edilsin baha olanlari ekranda cap eden function yazin
...
// console.log(filterByPrice(1000));


// Task3
// foreachdan istifade ederek userlerin namelerini hamsini ekranda cap eden function yazin
...
//parametr olaraq gender qebul eden ve daxil etdiyimiz gender uzre butun userleri return ededn function yazin

function myfunction(gender) {
    for (i = 0; i < users.id; i++) {
        if (gender == "male") {
